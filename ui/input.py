...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        spacerItem = QtWidgets.QSpacerItem(198, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(198, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(198, 18, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "输入名称"))
        self.label.setText(_translate("Form", "请输入名称："))
